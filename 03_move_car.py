...
class UiMainWindow(QMainWindow, form_window):
    ...
    def __init__(self):
        ...
        # start car signal handling
        self.start_signal.connect(self.start_car)
    ...
    @pyqtSlot(bool)
    def start_car(self, start): # can accept parameter like this
        self.go.setText("Car Go" if start else "Car stopped")
